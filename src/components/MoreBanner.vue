<template>
    <section id="short_intro" class="pt-5 mb-n5">
        <h2 class="display-1 font-weight-light text-center mb-4">More About Me</h2>
        ...
        <v-slide-group
            ...
            center-active
            mandatory>
            <v-slide-item v-for="(item, i) in more_intro" :key="i" v-slot:default="{ active, toggle }">
                <v-card
